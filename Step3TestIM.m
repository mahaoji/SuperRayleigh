...
Y1=580;%The starting Y in the region of interestest

nAve=10;    % number of frames for camera average
...
param_center = [300 300];
IMtemp = I_m(param_center(1)-150+1:param_center(1)+150,param_center(2)-150+1:param_center(2)+150);
contrast = std(IMtemp(:))./mean(IMtemp(:))
...
% caxis([0 4096])
IMtemp0 = abs(output).^2;
IMtemp1 = IMtemp0(param_center(1)-150+1:param_center(2)+150,param_center(2)-150+1:param_center(2)+150);
contrast = std(IMtemp1(:))./mean(IMtemp1(:))
